...
let id=params.id
         ...
         let result=await fetch("https://restaurant-backend-4w5p.onrender.com/update/"+id) 
    ...
    let clickHandler=async()=>{
      ...
      let result=await fetch(`https://restaurant-backend-4w5p.onrender.com/update/${params.id}`,{
                 method:'Put',
