...
function Signup() {
    ...
    let clickHandler=async()=>{
      if(!name || !password || !email){
        ...
        let result=await fetch("https://restaurant-backend-4w5p.onrender.com/signup",{
              method:'post',
  ...
  return (
    ...
    <input type="text" className="form-control" /* id="exampleInputEmail1"  */aria-describedby="emailHelp" placeholder='Srijan Bhardwaj'  value={name}
  ...
  <div className="mb-3">
    ...
    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='srijan@gmail.com'  value={email}
